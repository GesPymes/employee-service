...
public class EmployeeMobilePhoneField implements QueryField {
    ...
    public void addToQuery(BooleanBuilder booleanBuilder, SearchCriteria searchCriteria) {
        booleanBuilder.and(predicateBuilder.getBooleanBuilder(QEmployeeEntity.employeeEntity.mobilePhone, searchCriteria));
    }
}
