...
public class EmployeeLastNameField implements QueryField {
    ...
    public void addToQuery(BooleanBuilder booleanBuilder, SearchCriteria searchCriteria) {
        booleanBuilder.and(predicateBuilder.getBooleanBuilder(QEmployeeEntity.employeeEntity.lastName, searchCriteria));
    }
}
